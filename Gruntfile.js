...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    ngconstant: {
      ...
      local: {
        options: {
          dest: '<%= yeoman.app %>/scripts/pathConstants.js'
        },
        constants: {
          PathConstants: {
            name: 'local',
            BASE_URL: 'http://localhost:9000/api/1',
          }
        }
      },
      development: {
        ...
        constants: {
          PathConstants: {
            name: 'development',
            BASE_URL: 'http://my-dev-server/api/1'
          }
        }
      }
      // production: {
      //   options: {
      //     dest: '<%= yeoman.dist %>/scripts/pathConstants.js'
      //   },
      //   constants: {
      //     ENV: {
      //       name: 'production',
